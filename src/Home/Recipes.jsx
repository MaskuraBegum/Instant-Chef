...
const Recipes = () => {
    ...
    const [data, setDataLength] = useState(6);
                ...
                <div>
                        ...
                        {recipes.length > 0 ? (
                            ...
                            <div className="col-span-full flex justify-center items-center h-60 w-full">
                                <div className="text-center">
                                    <p>No recipes found with ingredient "{searchIngredient}"</p>
                                    <p className="text-gray-600">Note: Check your spelling!</p>
                                    <p>But you can have a look at recipes that include at least one of your ingredients.</p>
                                    <button
                    ...
                    <div className="col-span-full flex justify-center items-center my-8">
                        <div className={data === recipes.length && 'hidden'}>
                            <button onClick={() => setDataLength(recipes.length)} className='btn btn-primary px-6'>Show all</button>
                        </div>
                    </div>
                </div>
            )}
